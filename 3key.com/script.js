;(() => {
  ...
  gsap.from('#navbar > *', { duration: 1, delay: 1, y: '-150%', stagger: 0.25 })
...
function calculator() {
  ...
  $.ajax({
    url: 'https://app.3key.live/Calculator/',
    type: 'post',
...
function contactus() {
  ...
  $.ajax({
    url: 'https://app.3key.live/Calculator/Contact/',
    type: 'post',
...
$('#hovertarget2').mouseenter(function () {
  $('.box').css('display', 'none')
})
